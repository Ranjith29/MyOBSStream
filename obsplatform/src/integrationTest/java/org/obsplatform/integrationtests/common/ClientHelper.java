...
public class ClientHelper {
    ...
    private static final String CREATE_CLIENT_URL = "/obsplatform/api/v1/clients?tenantIdentifier=default";
    ...
    public static void verifyClientCreatedOnServer(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        String CLIENT_URL = "/obsplatform/api/v1/clients/" + generatedClientID + "?tenantIdentifier=default";
