...
public class EventActionConstants {
	...
	public static final String EVENT_EDIT_TICKET="Edit Ticket";
	...
	public static final String EVENT_ORDER_REACTIVATE = "Order Reactivate";
	public static final String EVENT_ORDER_REACTIVATION_FEE = "Order Reactivation Fee";
	public static final String EVENT_TERMINATION_FEE = "Termination_Fee";
	public static final String EVENT_ORDER_RECONNECTION="Reconnection Service";
	public static final String EVENT_APPOINTMENT_TICKET="Appointment Ticket";
	public static final String EVENT_HARDWARE_SALE="Hardware Sale";
	...
	public static final String ACTION_SUBSCRIPTION_DEPOSIT ="Subscription Deposit";
	public static final String ACTION_ORDER_REACTIVATE="Reactivate";
	public static final String ACTION_ORDER_REACTIVATION_FEE="Reactivation_Fee";
	public static final String TERMINATION_FEE = "Termination_Fee";
	public static final String ACTION_ORDER_RECONNECTION="Reconnect";
	
	public static final String ACTION_SEND_CLIENTCREATION_EMAIL="Send ClientCreation Email";
	
	/**
	 *  Actions For Ticket Creating
	**/
	public static final String ACTION_TICKET_CREATION="Ticket Creation";
	
	/**
	 *  Quotation constants
	 */
	public static final String EVENT_PROSPECT_CREATION="Prospect Creation";
	public static final String ACTION_PROSPECT_QUOTATION="Prospect Quotation";
	public static final String ACTION_CLIENT_QUOTATION="Client Quotation";
