...
public class UserChatReadplatformReadServiceImpl implements UserChatReadplatformReadService{
    ...
    @Autowired
    public UserChatReadplatformReadServiceImpl(final PlatformSecurityContext context, final RoutingDataSource dataSource) {
	...
	public List<UserChatData> getUserChatDetails() {
    	...
    	try{
    		...
    		String sql = "select " + mapper.schema()+" where u.username=? and u.request_type = 'USERCHATMESSAGE' and u.is_deleted='N'  order by u.message_date desc ";
