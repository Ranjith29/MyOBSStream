...
public class ClientProspectData {
	...
	private ProspectPlanCodeData prospectOrder;
	private ClientProspectCardDetailsData clientProspectCardDetailsData;
	...
	public ClientProspectData(final Long id, final Short prospectType,
			...
			final String isDeleted, final String actionName) {
		this.id = id;
		this.prospectType = prospectType;
		this.firstName = firstName;
		this.middleName = middleName;
	...
	public ProspectPlanCodeData getProspectOrder() {
		return prospectOrder;
	}

	public void setProspectOrder(ProspectPlanCodeData prospectOrder) {
		this.prospectOrder = prospectOrder;
	}

	public ClientProspectCardDetailsData getClientProspectCardDetailsData() {
		return clientProspectCardDetailsData;
	}

	public void setClientProspectCardDetailsData(ClientProspectCardDetailsData clientProspectCardDetailsData) {
		this.clientProspectCardDetailsData = clientProspectCardDetailsData;
	}
