...
public class PartnersData {
	...
	private Collection<CodeValueData> partnerTypes;
	private Long partnerTypeId;
	private String partnerTypeName;
	
	
	public PartnersData(List<String> countryData, List<String> statesData, List<String> citiesData, 
			Collection<CodeValueData> officeTypes, ApplicationCurrencyConfigurationData currencyData, 
			Collection<OfficeData> allowedParents, Collection<CountryCurrencyData> configCurrency, 
			Collection<CodeValueData> partnerTypes) {
	...
	public PartnersData(final Long officeId,final Long additionalinfoId,final String partnerName, final BigDecimal creditLimit, 
			...
			final String companyLogo, final Long partnerTypeId) {
	...
	public PartnersData(final Long id, final String partnerName, final Long partnerTypeId, final String partnerTypeName) {
	...
	public Collection<CodeValueData> getPartnerTypes() {
		return partnerTypes;
	}

	public void setPartnerTypes(Collection<CodeValueData> partnerTypes) {
		this.partnerTypes = partnerTypes;
	}
