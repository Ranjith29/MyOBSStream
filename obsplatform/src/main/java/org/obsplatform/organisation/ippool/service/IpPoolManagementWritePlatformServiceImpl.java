		...
		try {
			...
			if (subnet != null) {
				...
				for (int i = 0; i < data.length; i++) {
					int j = i + 1;
					IpPoolManagementDetail ipPoolManagementDetail = new IpPoolManagementDetail(data[i], 'F', type, notes, subnet);
				...
				String i = "1";
				IpPoolManagementDetail ipPoolManagementDetail = new IpPoolManagementDetail(ipAddress, 'F', type, notes, null);
				this.ipPoolManagementJpaRepository.save(ipPoolManagementDetail);
