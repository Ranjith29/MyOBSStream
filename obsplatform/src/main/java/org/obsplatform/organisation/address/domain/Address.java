...
public class Address extends AbstractAuditableCustom<AppUser, Long>{
	...
	public Address(final Long clientId,final String addressKey, final String addressNo, final String street, final String distributionBox,
	...
	public static Address fromJson(final Long clientId, final JsonCommand command) {
		...
		final String distributionBox = command.stringValueOfParameterNamed("distributionBox");
		...
		return new Address(clientId, addressKey, addressNo, street, distributionBox, city, state, country, zip, phone, email);
	}
	...
	public Map<String, Object> update(final JsonCommand command) {
		...
		final String distributionBoxParamName = "distributionBox";
		if (command.isChangeInStringParameterNamed(distributionBoxParamName, this.distributionBox)) {
			final String newValue = command.stringValueOfParameterNamed(distributionBoxParamName);
			actualChanges.put(distributionBoxParamName, newValue);
			this.distributionBox = StringUtils.defaultIfEmpty(newValue, null);
		}
