...
public class CommandWrapper {
	...
	public boolean isPaymentProspect(){
		return this.entityName.equalsIgnoreCase("PROSPECT") && this.actionName.equalsIgnoreCase("PAYMENT");
	}
	
	public boolean isRecurringResource() {
		return this.entityName.equalsIgnoreCase("RECURRING");
	}

	public boolean isAuthorize() {
		return this.actionName.equalsIgnoreCase("AUTHORIZE") && this.entityName.equalsIgnoreCase("RECURRING");
	}

	public boolean isUpdateProfile() {
		return this.actionName.equalsIgnoreCase("UPDATEPROFILE") && this.entityName.equalsIgnoreCase("RECURRING");
	}

	public boolean isNotifyAuthorizeRequest() {
		return this.actionName.equalsIgnoreCase("NOTIFY") && this.entityName.equalsIgnoreCase("RECURRING");
	}
	
	public boolean isDepartmentResource() {
		return this.entityName.equalsIgnoreCase("DEPARTMENT");
	}
	public boolean isCreateDepartment() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("DEPARTMENT");
	}
	public boolean isUpdateDepartment() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("DEPARTMENT");
	}
	public boolean isDeleteDepartment() {
		return this.actionName.equalsIgnoreCase("DELETE") && this.entityName.equalsIgnoreCase("DEPARTMENT");
	}
	
	public boolean isEmployeeResource() {
		return this.entityName.equalsIgnoreCase("EMPLOYEE");
	}
	public boolean isCreateEmployee() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("EMPLOYEE");
	}
	public boolean isUpdateEmployee() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("EMPLOYEE");
	}
	public boolean isDeleteEmployee() {
		return this.actionName.equalsIgnoreCase("DELETE") && this.entityName.equalsIgnoreCase("EMPLOYEE");
	}

	public boolean iscreditcardPayment() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("CREDITCARDPAYMENT");
	}
	public boolean isDeleteOrderNoRecord() {
		return this.actionName.equalsIgnoreCase("DELETENORECORD") && this.entityName.equalsIgnoreCase("ORDER");
	}
	
	public boolean isClientOrderNoRecord() {
		return this.actionName.equalsIgnoreCase("DELETENORECORD") && this.entityName.equalsIgnoreCase("CLIENT");
	}
	

	public boolean updateClientRequiredFields() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("CLIENTREQUIREDFIELDS");
	}
	
	
	public boolean isRegistrationFee() {
		return this.entityName.equalsIgnoreCase("REGISTRATIONFEE");
	}
	
	//for worldpay
	public boolean iscreditcardPaymentWorldpay() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("WORLDPAYPAYMENTGATEWAY");
	}
	
	
	//for wifi funtly
	public boolean isWifiResource(){
		return this.entityName.equalsIgnoreCase("WIFIMASTER");
	}
	public boolean isCreateWifi(){
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("WIFIMASTER");	
	}
	public boolean isUpdateWifi(){
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("WIFIMASTER");	
	}
	public boolean isDeleteWifi(){
		return this.actionName.equalsIgnoreCase("DELETE") && this.entityName.equalsIgnoreCase("WIFIMASTER");	
	}
	
	public boolean isExDirectoryResource() {
		return this.entityName.equalsIgnoreCase("ISEXDIRECTORY");
	}
	public boolean isCreateIsExDirectory() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("ISEXDIRECTORY");
	}
	public boolean isUpdateIsExDirectory() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("ISEXDIRECTORY");
	}
	
	public boolean isServicePartnerMappingResource() {
		return this.entityName.equalsIgnoreCase("SERVICEPARTNERMAPPING");
	}
	
	public boolean isCreateServicePartnerMapping() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("SERVICEPARTNERMAPPING");
	}
	
	public boolean isUpdateServicePartnerMapping() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("SERVICEPARTNERMAPPING");
	}
	
	public boolean isDeleteServicePartnerMapping(){
		return this.actionName.equalsIgnoreCase("DELETE") && this.entityName.equalsIgnoreCase("SERVICEPARTNERMAPPING");	
	}

	//TicketAssignRule
	public boolean isTicketAssignRuleResource() {
		return this.entityName.equalsIgnoreCase("TICKETASSIGNRULE");
	}
	
	public boolean isCreateTicketAssignRule() {
		return this.actionName.equalsIgnoreCase("CREATE") && this.entityName.equalsIgnoreCase("TICKETASSIGNRULE");
	}
	
	public boolean isUpdateTicketAssignRule() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("TICKETASSIGNRULE");
	}
	
	public boolean isDeleteTicketAssignRule() {
		return this.actionName.equalsIgnoreCase("DELETE") && this.entityName.equalsIgnoreCase("TICKETASSIGNRULE");
	}
	
	public boolean isNewPasswordRequest() {
		return this.actionName.equalsIgnoreCase("NEWPASSWORDREQUEST") && this.entityName.equalsIgnoreCase("ORDER");
	}
	
	public boolean isResetPasswordRequest() {
		return this.actionName.equalsIgnoreCase("RESETPASSWORDREQUEST") && this.entityName.equalsIgnoreCase("ORDER");
	}
	
	public boolean isDeleteAddon() {
		 return this.actionName.equalsIgnoreCase("DELETE") && this.entityName.equalsIgnoreCase("ORDERADDONS");
	}
	

	public boolean isCancelAddOn() {
		 return this.actionName.equalsIgnoreCase("CANCEL") && this.entityName.equalsIgnoreCase("ORDERADDONS");
	}
	
	public boolean isRefundPayment() {
		 return this.actionName.equalsIgnoreCase("REFUND") && this.entityName.equalsIgnoreCase("PAYMENT");
	}
	
	public boolean isUpdateClientRequiredFields() {
		return this.actionName.equalsIgnoreCase("UPDATEREQUIREDFIELDS");
	}
	
	public boolean isSetupFee() {
		return this.entityName.equalsIgnoreCase("SETUPFEE");
	}
