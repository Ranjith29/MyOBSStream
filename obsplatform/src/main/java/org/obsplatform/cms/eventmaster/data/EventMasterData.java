...
public class EventMasterData {
     ...
     * @param  eventCategory 
     */
	/**  this is change by anil for vod 
	 * 
	...
	public EventMasterData(final Long id, final String eventName, final String eventDescription,
			   final String status, final String mediaTitle, final LocalDate createdDate, 
	...
	public EventMasterData(Long id, Long eventId, String eventName,
			Long planId) {
		this.planEventId = id;
		this.eventName = eventName;
	...
	public EventMasterData(Long id, Long orderId, String eventName,
			String eventDescription, Long eventId) {
