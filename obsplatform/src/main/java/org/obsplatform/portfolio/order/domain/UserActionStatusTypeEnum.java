...
public enum UserActionStatusTypeEnum {
	...
	SUSPENSION(13,"CategoryType.suspension"),
	...
	REBOOT(17,"CategoryType.reboot"),
	RELOAD(18,"CategoryType.reload"),
	INVALID(19, "CategoryType.invalid");
	...
	public static UserActionStatusTypeEnum fromInt(final Integer frequency) {
		...
		case 13:
			actionStatusTypeEnum = UserActionStatusTypeEnum.SUSPENSION;
		...
		case 17:
			actionStatusTypeEnum  = UserActionStatusTypeEnum.REBOOT;
		case 18:
			actionStatusTypeEnum  = UserActionStatusTypeEnum.RELOAD;
