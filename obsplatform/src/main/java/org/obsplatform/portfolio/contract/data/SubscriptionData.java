...
public class SubscriptionData {
	...
	public SubscriptionData(final Long id, final String subscriptionPeriod,final String subscriptionType, 
			final Long units,final Long subscriptiontypeid,final String day_name) {
