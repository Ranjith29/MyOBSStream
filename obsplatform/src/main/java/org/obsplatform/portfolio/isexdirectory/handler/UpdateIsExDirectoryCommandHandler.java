 ...
 */
@Service
public class UpdateIsExDirectoryCommandHandler implements NewCommandSourceHandler {

    private final IsExDirectoryWritePlatformService isExDirectoryWritePlatformService;

    @Autowired
    public UpdateIsExDirectoryCommandHandler(final IsExDirectoryWritePlatformService isExDirectoryWritePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.isExDirectoryWritePlatformService.updateIsExDirectory(command.entityId(), command);
    }
}