package org.obsplatform.portfolio.servicepartnermapping.serialization;
 ...
 */
@Component
public class ServicePartnerMappingCommandFromApiJsonDeserializer {

	/**
	 * The parameters supported for this command.
	 * 
	 */
	final private Set<String> supportedParameters = new HashSet<String>(Arrays.asList("id", "serviceId", "partnerName", "locale"));

	private final FromJsonHelper fromApiJsonHelper;

	@Autowired
	public ServicePartnerMappingCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
	...
	public void validateForCreate(final String json) {
		...
		final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors).resource("ervicePartnerMapping");
