...
public class ClientApiConstants {
    ...
    public static final String distributionBoxParamName="distributionBox";
    ...
    public static final String isautobilling = "isautobilling";
    public static final String uniqueReferenceParamName = "uniqueReference";
    
    public static final String isEnableMarketingMails = "isEnableMarketingMails";
    ...
    public static final String cvvNumberParamName ="cvvNumber";
    public static final String expiryDateParamName ="expiryDate";
    public static final String cardExpiryDateParamName ="cardExpiryDate";
    ...
    public static final Set<String> CLIENT_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,titleParamName,
            ...
            addressNoParamName,cityParamName,countryParamName,emailParamName,phoneParamName,homePhoneNumberParamName,stateParamName,streetParamName, distributionBoxParamName,
            ...
            cardNumberParamName,cardTypeParamName,cvvNumberParamName,expiryDateParamName,typeParamName,cardExpiryDateParamName));
    ...
    public static final Set<String> CLIENT_UPDATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,titleParamName,
            ...
            jobTitleParamName,fiananceIdParamName,utsCustomerIdParamName,genderParamName,dateOfBirthParamName,nationalityParamName,idTypeParamName,
            idNumberParamName,remarksParamName,preferredLangParamName,ageGroupParamName,preferredCommunicationParamName,registrationFlagParamName,isautobilling,isEnableMarketingMails));
