...
public final class SearchParameters {
    ...
    public static SearchParameters forClients(final String sqlSearch, final Long officeId, final String externalId,
            ...
            final Integer limit, final String orderBy, final String sortOrder,final String groupName,final String status,final Long categorytype) {
        ...
        return new SearchParameters(sqlSearch, officeId, externalId, displayName, hierarchy, firstname, lastname, offset, maxLimitAllowed,
                orderBy, sortOrder,groupName,status,null,null,null,null,null,null,null,null,null,null,null,null,categorytype);
    }
    ...
    private SearchParameters(final String sqlSearch, final Long officeId, final String externalId, final String name,
            ...
            String phone,String searchType, String city, String address,Long categorytype) {
