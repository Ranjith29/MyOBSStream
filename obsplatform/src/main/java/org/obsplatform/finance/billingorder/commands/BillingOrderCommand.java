...
public class BillingOrderCommand {
	...
	private final List<UsageChargesData> usageChargeDatas;
	...
	public BillingOrderCommand(Long clientOrderId, Long oderPriceId,Long clientId, Date startDate, Date nextBillableDate, Date endDate,
			...
			final DiscountMasterData discountMasterData, final Integer taxInclusive, final String transactionType,
			final List<UsageChargesData> usageChargeDatas) {
		...
		this.usageChargeDatas = usageChargeDatas;
	...
	public List<UsageChargesData> getUsageChargeDatas() {
		return usageChargeDatas;
	}
