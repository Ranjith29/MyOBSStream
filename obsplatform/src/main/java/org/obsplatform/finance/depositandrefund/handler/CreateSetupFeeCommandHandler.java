...
@Service
public class CreateSetupFeeCommandHandler implements NewCommandSourceHandler {

	private final DepositeWritePlatformService depositewritePlatformService;

	@Autowired
	public CreateSetupFeeCommandHandler(
	...
	public CommandProcessingResult processCommand(final JsonCommand command) {
		...
		return this.depositewritePlatformService.createSetupFee(command);
	}
}
