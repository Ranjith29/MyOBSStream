...
@Service
public class CreateRegistrationFeeCommandHandler implements NewCommandSourceHandler {

	private final DepositeWritePlatformService depositewritePlatformService;

	@Autowired
	public CreateRegistrationFeeCommandHandler(
	...
	public CommandProcessingResult processCommand(final JsonCommand command) {
		...
		return this.depositewritePlatformService.createRegistrationFee(command);
	}
}
