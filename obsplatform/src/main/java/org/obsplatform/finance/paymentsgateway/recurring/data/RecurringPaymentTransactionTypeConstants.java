...
public class RecurringPaymentTransactionTypeConstants {
	...
	// Constant Values for RecurringBilling table gateway_name table.
	public static final String GATEWAY_NAME_PAYPAL = "paypal";
	public static final String GATEWAY_NAME_AUTHORIZENET = "authorizenet";
