...
@Service
public class UpdateSelfcarePasswordCommandHandler implements NewCommandSourceHandler{

	private final SelfCareWritePlatformService selfCareWritePlatformService; 
	
	@Autowired
	public UpdateSelfcarePasswordCommandHandler(final SelfCareWritePlatformService selfCareWritePlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return selfCareWritePlatformService.changeSelfcarePassword(command);
	}
