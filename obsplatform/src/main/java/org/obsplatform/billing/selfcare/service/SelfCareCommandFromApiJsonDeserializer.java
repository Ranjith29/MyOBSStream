...
private final Set<String> supportedParameters = new HashSet<String>(Arrays.asList("clientId","userName","password","uniqueReference","isDeleted","returnUrl",
	...
	public void validateForChangePassword(final JsonCommand command) {
		...
		final String userName = fromApiJsonHelper.extractStringNamed("userName", element); 
    	baseDataValidator.reset().parameter("userName").value(userName).notNull().notExceedingLengthOf(200);
