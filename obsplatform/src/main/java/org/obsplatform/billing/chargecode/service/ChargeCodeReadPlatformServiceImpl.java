...
public class ChargeCodeReadPlatformServiceImpl implements ChargeCodeReadPlatformService {
	...
	@Autowired
	public ChargeCodeReadPlatformServiceImpl(final RoutingDataSource dataSource) {
	...
	private static final class ChargeTypeDataMapper implements RowMapper<ChargeTypeData> {
	...
	private static final class DurationTypeDataMapper implements RowMapper<DurationTypeData> {
	...
	private static final class BillFrequencyMapper implements RowMapper<BillFrequencyCodeData> {
	 ...
	 */
	public ChargeCodeData retrieveSingleChargeCodeDetails(final Long chargeCodeId) {
