...
public class DiscountMasterData {
	...
	public DiscountMasterData(final Long id, final String discountCode,final String discountDescription, final String discountType,
			final BigDecimal discountRate, final LocalDate startDate, final LocalDate endDate,final String discountStatus) {
	...
	public Collection<MCodeData> getClientCategoryDatas() {
	...
	public List<DiscountDetailData> getDiscountDetailDatas() {
		return discountDetailDatas;
	}
