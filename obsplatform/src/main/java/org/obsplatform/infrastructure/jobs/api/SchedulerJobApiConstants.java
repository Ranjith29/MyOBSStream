...
public class SchedulerJobApiConstants {
	...
	public static final String JOB_EVO_BATCH_PROCESSING = "EVO BATCH PROCESS";
	public static final String JOB_VALUE = "value";
    ...
    public static final Set<String> JOB_DETAIL_RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(jobIdentifierParamName,
            ...
            schedulerJobLogFile,jobHistoryId, JOB_VALUE));
    ...
    public static final Set<String> JOB_HISTORY_RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(versionParamName,
            ...
            jobRunErrorLogParamName, JOB_VALUE));

    public static final Set<String> JOB_UPDATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(displayNameParamName,
            jobActiveStatusParamName, cronExpressionParamName,cronDescriptionParamName,jobIsDynamic,"isAutoRenewal",JOB_ADDON_EXIPIRY, JOB_VALUE));
    
    public static final Set<String> JOB_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(displayNameParamName,
            jobActiveStatusParamName, cronExpressionParamName,schedulerJobParamName,cronDescriptionParamName, JOB_VALUE));
    ...
    public static final Set<String> CREATE_REQUEST_JOB_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(jobProcessdate,jobDueDate,jobPromotionalMessage,JOB_ADDON_EXIPIRY,
    		...
    		JOB_REPORTEMAIL,JOB_EmailId,JOB_ProvSystem,JOB_URL,JOB_Username,JOB_Password,JOB_MiddleWare,"isDisconnectUnpaidCustomers", JOB_VALUE));
