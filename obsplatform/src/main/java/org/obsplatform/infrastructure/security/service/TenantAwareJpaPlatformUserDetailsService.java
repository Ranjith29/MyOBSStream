...
import org.obsplatform.infrastructure.security.service.PlatformUserDetailsService;
...
public class TenantAwareJpaPlatformUserDetailsService implements PlatformUserDetailsService {
    ...
    @Override
    @Cacheable(value = "usersByUsername", key = "T(org.obsplatform.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#username+'ubu')")
