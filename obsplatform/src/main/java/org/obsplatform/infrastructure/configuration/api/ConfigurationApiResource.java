...
public class ConfigurationApiResource {
    ...
    public String retrieveAllConfigurations(@Context final UriInfo uriInfo,@QueryParam("tenant") String tenant) throws JSONException {
       ...
       // String defaultConfiguration = "";
		...
		defaultOne.put("isCustomerLevelDeposit", "false");
		defaultOne.put("isVodMappingToPlan", "false");
		defaultOne.put("isDeleteForCustomerAndOrder", "false");
		
		defaultOne.put("registrationFee", "false");
		defaultOne.put("wifiDetails", "false");
		defaultOne.put("distributionBox", "false");
		defaultOne.put("isExDirectory", "false");
		defaultOne.put("setupFee", "false");
