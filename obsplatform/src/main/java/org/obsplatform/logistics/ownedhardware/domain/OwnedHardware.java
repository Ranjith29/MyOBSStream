...
public class OwnedHardware extends AbstractAuditableCustom<AppUser, Long>{
	...
	private OwnedHardware(final Long clientId, final String serialNumber, final String provisioningSerialNumber, final Date allocatedDate, 
			final String status, final String itemType){
