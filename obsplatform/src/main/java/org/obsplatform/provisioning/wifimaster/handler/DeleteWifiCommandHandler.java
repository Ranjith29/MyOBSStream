...
//@CommandType(entity = "BLEND", action = "DELETE")
@Service
public class DeleteWifiCommandHandler implements NewCommandSourceHandler {

	private final WifiMasterWritePlatformService wifiMasterWritePlatformService;

	@Autowired
	public DeleteWifiCommandHandler(
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return wifiMasterWritePlatformService.deleteWifi(command.entityId());
	}
