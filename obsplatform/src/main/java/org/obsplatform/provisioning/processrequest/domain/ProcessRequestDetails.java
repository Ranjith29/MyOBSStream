...
public class ProcessRequestDetails extends AbstractAuditableCustom<AppUser, Long> {
 ...
 public ProcessRequestDetails(Long orderlinId, Long serviceId, String sentMessage, String recievedMessage,
   String hardwareId, Date startDate, Date endDate, Date sentDate, Date recievedDate, char isDeleted,
 ...
 public ProcessRequestDetails(ProcessRequest processRequest, Long orderlinId, Long serviceId, String sentMessage,
   String receiveMessage, String requestType, String hardwareId, Date startDate, Date endDate, Date sentDate,
   Date receivedDate, String receivedStatus) {
