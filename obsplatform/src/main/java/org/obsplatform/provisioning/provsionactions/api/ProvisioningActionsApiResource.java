...
public class ProvisioningActionsApiResource {
	...
	private static final Set<String> RESPONSE_DATA_PARAMETERS = new HashSet<String>(Arrays.asList("id","provisionType","action","provisionigSystem","isEnable"));
...
public String retrieveAllProvisioningActions(@Context final UriInfo uriInfo){
    ...
    return this.toApiJsonSerializer.serialize(settings, provisioningActionDatas, RESPONSE_DATA_PARAMETERS);
}
